...
export const indigenousActivities: AnyActivity[] = [
  // -- ChiShona Greetings --
  {
    ...
    items: [
      ...
      { id: "i4", stimulus: { text: { en: "Thank you" } }, is_correct: false, alt: { en: "Not a greeting" } },
    ],
  ...
  // -- isiNdebele Greetings --
  {
    ...
    items: [
      ...
      { id: "i4", stimulus: { text: { en: "Goodbye" } }, is_correct: false, alt: { en: "Not a greeting" } },
    ],
  ...
  // -- Animals in ChiShona --
  {
    ...
    pairs: [
      ...
      { id: "p4", left: { text: { en: "🐔 Chicken" } }, right: { text: { en: "Huku" } } },
    ],
  ...
  // -- Animals in isiNdebele --
  {
    ...
    pairs: [
      ...
      { id: "p4", left: { text: { en: "🐔 Chicken" } }, right: { text: { en: "Inkukhu" } } },
    ],
    layout: "two_column", shuffle_right: true,
  } as unknown as AnyActivity,
  ...
  // -- Colours in ChiShona (ECD_B) --
  {
    ...
    pairs: [
      ...
      { id: "p4", left: { text: { en: "🟡 Yellow" } }, right: { text: { en: "Yero" } } },
    ],
    layout: "two_column", shuffle_right: true,
  } as unknown as AnyActivity,
  ...
  // -- Numbers in ChiShona (ECD_B) --
  {
    ...
    pairs: [
      ...
      { id: "p4", left: { text: { en: "4 - Four" } }, right: { text: { en: "Ina" } } },
    ],
    layout: "two_column", shuffle_right: true,
  } as unknown as AnyActivity,
];
